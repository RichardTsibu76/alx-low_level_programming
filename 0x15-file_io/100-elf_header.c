...
/**
 *display_class - A function that displays
 *@e_ident: pointer to locate address
 *Return: Thsis is void it does not returni
 */
...
/**
 *display_magic - displays
 *@e_ident: a variable that points to the address
...
/**
 *display_data - This is the data function
...
/**
 *display_version - It a version displayer function
 *@e_ident: pointer variable
